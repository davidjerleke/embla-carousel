!(function (n, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : ((n =
        'undefined' != typeof globalThis
          ? globalThis
          : n || self).EmblaCarouselVue = t(n.Vue))
})(this, function (n) {
  'use strict'
  function t(n) {
    return (
  ...
  function E(n, t, e, r, o, i, u, d, f, p, m, g, h, y, b, S, E, L, O) {
    const { cross: D, direction: I } = n,
      A = ['INPUT', 'SELECT', 'TEXTAREA'],
      M = { passive: !1 },
      F = v(),
      T = v(),
      k = w(50, 225).constrain(y.measure(20)),
    ...
    let V = !1,
      ...
      q = !1
    function G(n) {
      if (!x(n, r) && n.touches.length >= 2) return U(n)
    ...
    function U(n) {
      const t = m.byDistance(0, !1).index !== g.get(),
        e = i.pointerUp(n) * (b ? z : P)[q ? 'mouse' : 'touch'],
        r = (function (n, t) {
          const e = g.add(-1 * a(n)),
            r = m.byDistance(n, !b).distance
          return b || s(n) < k
            ? r
            : E && t
            ? 0.5 * r
            : m.byIndex(e.get(), 0).distance
        })(I(e), t),
        o = (function (n, t) {
          if (0 === n || 0 === t) return 0
          if (s(n) <= s(t)) return 0
  ...
  function I(n, t, e, r) {
    const o = t.min + 0.1,
      i = t.max + 0.1,
      { reachedMin: c, reachedMax: u } = w(o, i)
    return {
      loop: function (t) {
        if (
          !(function (n) {
  ...
  function A(n, t, e, r, o) {
    ...
    return {
      byDistance: function (e, r) {
        ...
        return !r || p
          ? { index: l, distance: e }
          : { index: l, distance: e + d(t[l] - f, 0) }
      },
      byIndex: function (n, e) {
        return { index: n, distance: d(t[n] - o.get(), e) }
      },
      shortcut: d
    }
  }
                ...
                ? d(n)
                    .reduce((e, o, d) => {
                      const y = f(e) || 0,
                        ...
                        E = s(w - (!r && v ? h(a) : 0) - (b + S))
                      return (
                        d && E > t + l && e.push(o), v && e.push(n.length), e
                      )
                    }, [])
                    .map((t, e, r) => {
    ...
    const {
      ...
      rn = j || !!U,
      {
        ...
        const { measureSize: c, startEdge: u, endEdge: a } = n,
          ...
          p = (function () {
            if (!l) return 0
            const n = i.getComputedStyle(f(r))
          ...
          h = e
            .map((n, t, e) => {
              const r = !t,
                o = m(e, t)
              return r ? g[t] + d : o ? g[t] + p : e[t + 1][u] - n[u]
            })
            .map(s)
        return { slideSizes: g, slideSizesWithGaps: h, startGap: d, endGap: p }
      })(Z, Y, K, e, rn, o),
      an = H(Z, _, q, j, Y, K, un, sn, 2),
      { snaps: ln, snapsAligned: dn } = (function (n, t, e, r, o) {
        const { startEdge: i, endEdge: c } = n,
          ...
          a = u(r)
            ...
            .map(s)
            .map(t.measure),
          l = r.map((n) => e[i] - n[i]).map((n) => -s(n)),
          d = u(l)
            .map((n) => n[0])
            .map((n, t) => n + a[t])
        return { snaps: l, snapsAligned: d }
      })(Z, tn, Y, K, an),
      fn = -f(ln) + f(cn),
      { snapsContained: pn, scrollContainLimit: mn } = (function (
        ...
        const i = w(-t + n, 0),
          ...
          u = (function () {
            const n = c[0],
              t = f(c)
            return w(c.lastIndexOf(n), c.indexOf(t) + 1)
          })()
        function s(n, t) {
          return l(n, t) <= 1
        }
      ...
      zn = {
        ...
        previousLocation: En,
        options: c,
        resizeHandler: O(t, u, o, e, Z, $, X),
        scrollBody: Dn,
        scrollBounds: D(hn, Ln, On, Dn, nn),
        scrollLooper: I(fn, hn, Ln, [Sn, Ln, En, On]),
        scrollProgress: Mn,
        scrollSnapList: gn.map(Mn.get),
        scrollSnaps: gn,
        scrollTarget: In,
        scrollTo: An,
        slideLooper: k(Z, _, fn, on, cn, ln, gn, Ln, e),
        slideFocus: Pn,
    ...
    function I(t, e) {
      S ||
        ...
        (function () {
          ...
          b = r || n.children[0]
          const o = i(e) ? b.querySelectorAll(e) : e
        ...
        L.active &&
          ...
          b.offsetParent && w.length && y.dragHandler.init(k),
          (x = u.init(k, O))))
    }
    function A(n, t) {
      const e = T()
  ...
  function N(t = {}, o = []) {
    ...
    let u = i ? t.value : t,
      s = c ? o.value : o
    const a = n.shallowRef(),
      l = n.shallowRef()
    function d() {
      l.value && l.value.reInit(u, s)
    }
    return (
      n.onMounted(() => {
        'undefined' != typeof window &&
          ...
          a.value &&
          ((B.globalOptions = N.globalOptions), (l.value = B(a.value, u, s)))
      }),
      n.onBeforeUnmount(() => {
  ...
  return (B.globalOptions = void 0), (N.globalOptions = void 0), N
})
