!(function (n, t) {
  ...
  function t(e, r) {
    ...
    return (
      JSON.stringify(Object.keys(e.breakpoints || {})) ===
        JSON.stringify(Object.keys(r.breakpoints || {})) &&
      o.every((o) => {
        const i = e[o],
          c = r[o]
  ...
  function w(n, t, e) {
    const { constrain: r } = v(0, n),
      o = n + 1
    let i = c(t)
    function c(n) {
      return e ? u((o + n) % o) : r(n)
    }
    function s() {
      return i
    }
  ...
  function S(n, t, e, r, o, c, l, d, f, p, g, m, h, b, w, S, E, L, O) {
    const { cross: D, direction: I } = n,
      A = ['INPUT', 'SELECT', 'TEXTAREA'],
      M = { passive: !1 },
      F = x(),
      T = x(),
      k = v(50, 225).constrain(b.measure(20)),
    ...
    let j = !1,
      ...
      G = !1
    function q(n) {
      if (!y(n, r) && n.touches.length >= 2) return $(n)
      const t = c.readPoint(n),
        e = c.readPoint(n, D),
        i = a(t, V),
        u = a(e, B)
      if (!N && !G) {
    ...
    function $(n) {
      const t = g.byDistance(0, !1).index !== m.get(),
        e = c.pointerUp(n) * (w ? z : P)[G ? 'mouse' : 'touch'],
        r = (function (n, t) {
          const e = m.add(-1 * s(n)),
            r = g.byDistance(n, !w).distance
          return w || u(n) < k
            ? r
            : E && t
            ? 0.5 * r
      ...
      ;(N = !1),
        (C = !1),
        T.clear(),
        p.useDuration(i).useFriction(l),
        f.distance(r, !w),
        (G = !1),
        h.emit('pointerUp')
    }
    function U(n) {
      R && (n.stopPropagation(), n.preventDefault(), (R = !1))
    }
    return {
      init: function (n) {
        if (!O) return
        ...
        const s = t
        F.add(s, 'dragstart', (n) => n.preventDefault(), M)
          .add(s, 'touchmove', () => {}, M)
          .add(s, 'touchend', () => {})
          .add(s, 'touchstart', u)
          .add(s, 'mousedown', u)
    ...
    return {
      ...
      pointerUp: function (n) {
        ...
        const t = i(r) - i(e),
          ...
          s = o(n) - o(r) > 170,
          a = t / c
        return c && !s && u(a) > 0.1 ? a : 0
      },
      readPoint: i
    }
  }
  function L(n, t, e, r, o, c, s) {
    const a = [n].concat(r)
    let l,
      d,
      f = [],
      p = !1
    function g(n) {
      return o.measureSize(s.measure(n))
    }
    return {
      init: function (o) {
        c &&
  ...
  function D(n, t, e, r) {
    const o = t.min + 0.1,
      i = t.max + 0.1,
      { reachedMin: c, reachedMax: u } = v(o, i)
    return {
      loop: function (t) {
        if (
          !(function (n) {
  ...
  function I(n, t, e, r, o) {
    const { reachedAny: i, removeOffset: c, constrain: a } = r
    function l(n) {
      return n.concat().sort((n, t) => u(n) - u(t))[0]
    }
    function f(t, r) {
      const o = [t, t + e, t - e]
      if (!n) return t
      if (!r) return l(o)
      const i = o.filter((n) => s(n) === r)
      return i.length ? l(i) : d(o) - e
    }
    return {
      byDistance: function (e, r) {
        const s = o.get() + e,
          { index: l, distance: d } = (function (e) {
            const r = n ? c(e) : a(e),
              o = t
                .map((n, t) => ({ diff: f(n - r, 0), index: t }))
                .sort((n, t) => u(n.diff) - u(t.diff)),
              { index: i } = o[0]
        ...
        return !r || p
          ? { index: l, distance: e }
          : { index: l, distance: e + f(t[l] - d, 0) }
      },
      byIndex: function (n, e) {
        return { index: n, distance: f(t[n] - o.get(), e) }
      },
      shortcut: f
    }
  }
  function A(n, t, e, o, c, u, s, a) {
    const l = { passive: !0, capture: !0 }
    let d = 0
    function f(n) {
      'Tab' === n.code && (d = new Date().getTime())
    }
    return {
      init: function (p) {
        a &&
              ...
              (t) => {
                ;(i(a) || a(p, t)) &&
                  (function (t) {
                    ...
                    r(i) &&
                      (c.useDuration(0), o.index(i, 0), s.emit('slideFocus'))
                  })(f)
              },
              l
            )
                ...
                ? l(n)
                    .reduce((e, r, l) => {
                      const y = d(e) || 0,
                        ...
                        E = u(w - (!o && b ? h(a) : 0) - (v + S))
                      return (
                        l && E > t + p && e.push(r), b && e.push(n.length), e
                      )
                    }, [])
                    .map((t, e, r) => {
  ...
  function H(n, t, e, r, i, c, m) {
    const {
      ...
      rn = V || !!$,
      {
        ...
        const { measureSize: c, startEdge: s, endEdge: a } = n,
          l = e[0] && o,
          f = (function () {
            if (!l) return 0
            const n = e[0]
          ...
          g = (function () {
            if (!l) return 0
            const n = i.getComputedStyle(d(r))
            return parseFloat(n.getPropertyValue(`margin-${a}`))
          })(),
          m = e.map(c),
          h = e
            .map((n, t, e) => {
              const r = !t,
                o = p(e, t)
              return r ? m[t] + f : o ? m[t] + g : e[t + 1][s] - n[s]
            })
            .map(u)
        return { slideSizes: m, slideSizesWithGaps: h, startGap: f, endGap: g }
      })(Z, Y, K, e, rn, i),
      an = z(Z, _, G, V, Y, K, un, sn, 2),
      { snaps: ln, snapsAligned: dn } = (function (n, t, e, r, o) {
        const { startEdge: i, endEdge: c } = n,
          { groupSlides: s } = o,
          a = s(r)
            .map((n) => d(n)[c] - n[0][i])
            .map(u)
            .map(t.measure),
          l = r.map((n) => e[i] - n[i]).map((n) => -u(n)),
          f = s(l)
            .map((n) => n[0])
            .map((n, t) => n + a[t])
      ...
      fn = -d(ln) + d(cn),
      { snapsContained: pn, scrollContainLimit: gn } = (function (
        n,
        t,
        e,
        r,
        ...
        const i = v(-t + n, 0),
          ...
          u = (function () {
            const n = c[0],
              t = d(c)
            return v(c.lastIndexOf(n), c.indexOf(t) + 1)
          })()
        function s(n, t) {
          return a(n, t) <= 1
        }
      ...
      Fn = x(),
      Tn = P(t, e, m, R),
      { slideRegistry: kn } = (function (n, t, e, r, o, i) {
      ...
      zn = {
        ...
        previousLocation: En,
        options: c,
        resizeHandler: L(t, m, i, e, Z, U, X),
        scrollBody: Dn,
        scrollBounds: O(hn, Ln, On, Dn, nn),
        scrollLooper: D(fn, hn, Ln, [Sn, Ln, En, On]),
        scrollProgress: Mn,
        scrollSnapList: mn.map(Mn.get),
        scrollSnaps: mn,
        scrollTarget: In,
        scrollTo: An,
        slideLooper: T(Z, _, fn, on, cn, ln, mn, Ln, e),
        slideFocus: Pn,
        slidesHandler: k(t, m, W),
        slidesInView: Tn,
        slideIndexes: bn,
        slideRegistry: kn,
        slidesToScroll: an,
  ...
  function B(n, t, e) {
    ...
    let y,
      ...
      w,
      S = !1,
      E = l(j, B.globalOptions),
      L = l(E),
      O = []
    function D(t) {
      const e = H(n, v, w, r, i, t, a)
    ...
    function I(t, e) {
      S ||
        ...
        (O = e || O),
        (function () {
          const { container: t, slides: e } = L,
            r = o(t) ? n.querySelector(t) : t
          v = r || n.children[0]
          const i = o(e) ? v.querySelectorAll(e) : e
          w = [].slice.call(i || v.children)
        })(),
        (y = D(L)),
        f([E, ...O.map(({ options: n }) => n)]).forEach((n) =>
          s.add(n, 'change', A)
        ),
        L.active &&
          ...
          y.slidesInView.init(),
          y.slideFocus.init(k),
          y.eventHandler.init(k),
          y.resizeHandler.init(k),
          y.slidesHandler.init(k),
          y.options.loop && y.slideLooper.loop(),
          v.offsetParent && w.length && y.dragHandler.init(k),
          (b = u.init(k, O))))
    }
    function A(n, t) {
      const e = T()
      M(), I(l({ startIndex: e }, n), t), a.emit('reInit')
    }
    function M() {
    ...
    const k = {
      ...
      destroy: function () {
        S || ((S = !0), s.clear(), M(), a.emit('destroy'), a.clear())
      },
      off: g,
      on: p,
      emit: m,
    ...
    return I(t, e), setTimeout(() => a.emit('init'), 0), k
  }
  function C(n, r = { options: {}, plugins: [] }) {
    let o,
      i = r
    return (
      'undefined' != typeof window &&
        ...
        ((B.globalOptions = C.globalOptions),
        (o = B(n, i.options, i.plugins)),
        o.on('init', () =>
          n.dispatchEvent(new CustomEvent('emblaInit', { detail: o }))
        )),
      {
        destroy: () => {
          o && o.destroy()
        ...
        update: (n) => {
          const r = !t(i.options, n.options),
            c = !(function (n, r) {
              if (n.length !== r.length) return !1
              const o = e(n),
                i = e(r)
              return o.every((n, e) => t(n, i[e]))
            })(i.plugins, n.plugins)
          ;(r || c) && ((i = n), o && o.reInit(i.options, i.plugins))
        }
      }
    )
  }
  return (B.globalOptions = void 0), (C.globalOptions = void 0), C
})
