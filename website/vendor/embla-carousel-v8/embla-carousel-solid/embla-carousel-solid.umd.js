!(function (n, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = t(require('solid-js')))
    : 'function' == typeof define && define.amd
    ? define(['solid-js'], t)
    : ((n =
        'undefined' != typeof globalThis
          ? globalThis
          : n || self).EmblaCarouselSolid = t(n.solidJs))
})(this, function (n) {
  'use strict'
  function t(n) {
  ...
  function v(n, t, e, o, s, a, l, d, f, p, g, y, b, v, S, w, E, L, O) {
    const { cross: D, direction: I } = n,
      A = ['INPUT', 'SELECT', 'TEXTAREA'],
      M = { passive: !1 },
      F = h(),
      T = h(),
      k = x(50, 225).constrain(v.measure(20)),
    ...
    function $(n) {
      const t = g.byDistance(0, !1).index !== y.get(),
        e = a.pointerUp(n) * (S ? j : P)[q ? 'mouse' : 'touch'],
        r = (function (n, t) {
          const e = y.add(-1 * c(n)),
    ...
    return {
      init: function (n) {
        ...
        const c = t
        F.add(c, 'dragstart', (n) => n.preventDefault(), M)
          .add(c, 'touchmove', () => {}, M)
          .add(c, 'touchend', () => {})
          .add(c, 'touchstart', i)
          .add(c, 'mousedown', i)
            ...
            ;(r(u) || u(c, e)) &&
              (function (e) {
                for (const r of e) {
                  if (p) return
                  const e = r.target === n,
                    u = o.indexOf(r.target),
                    s = e ? d : f[u]
                  if (i(g(e ? n : o[u]) - s) >= 0.5) {
  ...
  function O(n, t, e, r, o) {
    const { reachedAny: u, removeOffset: s, constrain: l } = r
    function d(n) {
  ...
  function P(n, t, r, o, p, g, m) {
    const {
      ...
      rn = V || !!$,
      {
        ...
        const { measureSize: u, startEdge: s, endEdge: l } = n,
          f = e[0] && o,
          p = (function () {
            if (!f) return 0
            const n = e[0]
      ...
      jn = {
        ...
        previousLocation: En,
        options: g,
        resizeHandler: w(t, m, p, r, Z, U, X),
        scrollBody: Dn,
        scrollBounds: E(hn, Ln, On, Dn, nn),
        scrollLooper: L(fn, hn, Ln, [wn, Ln, En, On]),
        scrollProgress: Mn,
        scrollSnapList: mn.map(Mn.get),
        scrollSnaps: mn,
        scrollTarget: In,
        scrollTo: An,
        slideLooper: M(Z, _, fn, on, cn, ln, mn, Ln, r),
        slideFocus: Pn,
        slidesHandler: F(t, m, W),
        slidesInView: Tn,
        slideIndexes: bn,
        slideRegistry: kn,
        slidesToScroll: an,
  ...
  function H(n, t, r) {
    ...
    let x,
      ...
      S,
      w = !1,
      E = l(j, H.globalOptions),
      L = l(E),
      O = []
    function D(t) {
      const e = P(n, v, S, o, i, t, a)
    ...
    function I(t, r) {
      w ||
        ...
        L.active &&
          ...
          x.slidesInView.init(),
          x.slideFocus.init(k),
          x.eventHandler.init(k),
          x.resizeHandler.init(k),
          x.slidesHandler.init(k),
          x.options.loop && x.slideLooper.loop(),
          v.offsetParent && S.length && x.dragHandler.init(k),
          (b = u.init(k, O))))
    }
    function A(n, t) {
      const e = T()
    ...
    function F(n, t, e) {
      L.active &&
        !w &&
        (x.scrollBody.useBaseFriction().useDuration(!0 === t ? 0 : L.duration),
    ...
    return I(t, r), setTimeout(() => a.emit('init'), 0), k
  }
  function V(n) {
    return (
      (function (n) {
  ...
  function R(t, e) {
    ...
    return (
      n.createEffect(
        n.on(u, (t) => {
          if (B() && t) {
            H.globalOptions = R.globalOptions
            const e = H(t, r, o)
            c(e), n.onCleanup(() => e.destroy())
          } else c(void 0)
        })
      ),
      n.createEffect(() => {
      ...
      n.createEffect(() => {
        ...
        ;(function (n, t) {
          ...
          const e = N(n),
            r = N(t)
          return e.every((n, t) => C(n, r[t]))
        })(o, n) || ((o = n), a())
      }),
      [s, i]
    )
  }
  return (H.globalOptions = void 0), (R.globalOptions = void 0), R
})
