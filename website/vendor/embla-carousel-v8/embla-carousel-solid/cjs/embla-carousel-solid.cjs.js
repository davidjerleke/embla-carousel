...
var EmblaCarousel = require('@vendor/embla-carousel-v8/embla-carousel')
var emblaCarouselReactiveUtils = require('@vendor/embla-carousel-v8/embla-carousel-reactive-utils')
...
function createEmblaCarousel(options, plugins) {
  ...
  solidJs.createEffect(() => {
    ...
    if (emblaCarouselReactiveUtils.areOptionsEqual(storedOptions, newOptions))
      return
  ...
  solidJs.createEffect(() => {
    ...
    if (emblaCarouselReactiveUtils.arePluginsEqual(storedPlugins, newPlugins))
      return
