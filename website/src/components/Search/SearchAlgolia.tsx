...
const contentStyles = css<KeyNavigatingPropType>`
  .DocSearch-NoResults,
...
const footerStyles = css<KeyNavigatingPropType>`
  .DocSearch-Footer {
    flex: 0 0 auto;
    padding-top: ${EDGE_SPACING};
    display: flex;
...
const inputStyles = css<KeyNavigatingPropType>`
  .DocSearch-Input {
...
const resetButtonStyles = css<KeyNavigatingPropType>`
  .DocSearch-Reset {
    ${buttonBareStyles};
    width: ${BUTTON_WIDTH};
    top: ${INPUT_BORDER_SIZE};
