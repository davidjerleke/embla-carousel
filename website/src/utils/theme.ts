...
export const THEME_CLASSNAME_LIGHT = `${THEME_PREFIX}${THEME_KEYS.LIGHT}`
export const THEME_CLASSNAME_DARK = `${THEME_PREFIX}${THEME_KEYS.DARK}`
...
/* UTILS */
function colorsToCssVariableMap(colors: ThemeColorsType): ThemeColorsType {
...
function themeToColorVariableStyles(colors: ThemeColorsType): string {
