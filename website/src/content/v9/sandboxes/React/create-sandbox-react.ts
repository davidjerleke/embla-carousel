...
import { createSandboxReactPackageJson } from '@/content/v9/sandboxes/React/create-sandbox-react-package-json'
import { createSandboxReactIndexHtml } from '@/content/v9/sandboxes/React/create-sandbox-react-index-html'
import { createSandboxReactEntry } from '@/content/v9/sandboxes/React/create-sandbox-react-entry'
import { createSandboxReactImagePaths } from '@/content/v9/sandboxes/React/create-sandbox-react-image-paths'
import { createSandboxReactHeader } from '@/content/v9/sandboxes/React/create-sandbox-react-header'
import { createSandboxReactFooter } from '@/content/v9/sandboxes/React/create-sandbox-react-footer'
import { createSandboxReactTsConfig } from '@/content/v9/sandboxes/React/create-sandbox-react-ts-config'
import {
