...
import classNamesInstallation_cdn_01 from '@/content/v9/code-snippets/plugins/class-names/installation-cdn-01.html'
import classNamesInstallation_npm_01 from '@/content/v9/code-snippets/plugins/class-names/installation-npm-01.sh'
import classNamesInstallation_yarn_01 from '@/content/v9/code-snippets/plugins/class-names/installation-yarn-01.sh'
import classNamesInstallation_pnpm_01 from '@/content/v9/code-snippets/plugins/class-names/installation-pnpm-01.sh'

import packageJson from '@packages/embla-carousel-class-names/package.json'
...
<Admonition type="note">
  This feature will honor the
  [`inViewThreshold`](/docs/api/options/#inviewthreshold) option.
</Admonition>
