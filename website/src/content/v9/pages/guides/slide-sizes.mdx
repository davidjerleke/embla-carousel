...
import slideSizes_01 from '@/content/v9/code-snippets/guides/slide-sizes/setting-sizes-01.less'
import breakpoints_01 from '@/content/v9/code-snippets/guides/slide-sizes/breakpoints-01.less'
import variableWidths_01 from '@/content/v9/code-snippets/guides/slide-sizes/variable-widths-01.less'

import { ExampleSlideSizesInteractive } from '@/content/v9/examples/Guides/SlideSizes/SlideSizesInteractiveLazy'
import { ExampleSlideSizesVariableWidths } from '@/content/v9/examples/Guides/SlideSizes/SlideSizesVariableWidthsLazy'
