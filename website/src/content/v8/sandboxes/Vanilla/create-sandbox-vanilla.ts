...
import { createSandboxVanillaPackageJson } from '@/content/v8/sandboxes/Vanilla/create-sandbox-vanilla-package-json'
import { createSandboxVanillaTsConfig } from '@/content/v8/sandboxes/Vanilla/create-sandbox-vanilla-ts-config'
import { createSandboxVanillaEntry } from '@/content/v8/sandboxes/Vanilla/create-sandbox-vanilla-entry'
import { createSandboxVanillaImagePaths } from '@/content/v8/sandboxes/Vanilla/create-sandbox-vanilla-image-paths'
import { createSandboxVanillaOptions } from '@/content/v8/sandboxes/Vanilla/create-sandbox-vanilla-options'
import {
