...
import classNamesInstallation_cdn_01 from '@/content/v8/code-snippets/plugins/class-names/installation-cdn-01.html'
import classNamesInstallation_npm_01 from '@/content/v8/code-snippets/plugins/class-names/installation-npm-01.sh'
import classNamesInstallation_yarn_01 from '@/content/v8/code-snippets/plugins/class-names/installation-yarn-01.sh'
import classNamesInstallation_pnpm_01 from '@/content/v8/code-snippets/plugins/class-names/installation-pnpm-01.sh'
...
<ApiMetaData
  firstRow={['Type', 'string | string[]']}
  secondRow={['Default', 'is-dragging']}
/>
<PrismHighlight
  language="ts"
  hideLabel
  code={`{ dragging: 'is-dragging' | ['is-dragging', 'is-dragging-2'] }`}
/>
