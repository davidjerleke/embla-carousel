...
import fadeInstallation_cdn_01 from '@/content/v8/code-snippets/plugins/fade/installation-cdn-01.html'
import fadeInstallation_npm_01 from '@/content/v8/code-snippets/plugins/fade/installation-npm-01.sh'
import fadeInstallation_yarn_01 from '@/content/v8/code-snippets/plugins/fade/installation-yarn-01.sh'
import fadeInstallation_pnpm_01 from '@/content/v8/code-snippets/plugins/fade/installation-pnpm-01.sh'
...
<Admonition type="note">
  ...
  [`inViewThreshold`](/docs/v8/api/options#inviewthreshold) option no longer has
