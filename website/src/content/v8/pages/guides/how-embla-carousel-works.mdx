...
import minimalDomManipulation_01 from '@/content/v8/code-snippets/guides/how-embla-carousel-works/minimal-dom-manipulation-01.html'
import minimalDomManipulation_02 from '@/content/v8/code-snippets/guides/how-embla-carousel-works/minimal-dom-manipulation-02.html'
import notes_01 from '@/content/v8/code-snippets/guides/how-embla-carousel-works/notes-01.html'
import notes_02 from '@/content/v8/code-snippets/guides/how-embla-carousel-works/notes-02.html'

import { ExampleMinimalDomManipulation } from '@/content/v8/examples/Guides/HowEmblaCarouselWorks/MinimalDomManipulationLazy'
...
- **Carousel slides** - applies `translate3d` to adjust slide positions (for looping).

You can see this in action by inspecting the following example in your browser's developer tools:

<ExampleMinimalDomManipulation />
