...
```css highlight={4,21,25}
.embla {
  --slide-size: 100%;
  --slide-spacing: 10px;
  --slide-spacing-md-up: 20px;
}
...
@media (min-width: 768px) {
  .embla__container {
    margin-left: calc(var(--slide-spacing-md-up) * -1); /* Renders -20px */
  }

  .embla__slide {
    padding-left: var(--slide-spacing-md-up);
  }
}
```
