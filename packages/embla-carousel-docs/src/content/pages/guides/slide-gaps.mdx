...
Try adjusting the slide size and gap below to display **multiple slides per view** — for example, three per view. The `--slide-size` variable is wrapped in a `calc()`, allowing you to write expressions directly.
