...
import { setupInfiniteScroll, mockApiCall, SLIDE_TEMPLATE, createHTMLFromString, } from './carouselInfiniteScrollHandler';
import '../css/base.css';
...
const addInfiniteScroll = setupInfiniteScroll(emblaApi, (loadMore, slideCount) => {
