...
const CarouselRightToLeft = lazy(() => {
  return import(
    'components/Sandbox/React/SandboxFilesSrc/RightToLeft/EmblaCarousel'
  )
})
...
const SANDBOXES = sandboxStaticSandboxes(SANDBOX_CONFIG, 'RightToLeft')
