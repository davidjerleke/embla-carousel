...
import {
  ...
  FIXTURE_LOOP_Y_1,
  FIXTURE_LOOP_Y_2
} from './fixtures/loop.fixture'

const scrollToLocation = (engine: EngineType, location: number): void => {
  ...
  describe('Carousel with slides WITHOUT MARGINS has correct:', () => {
    ...
    describe('Slide positions when align is START and the carousel is scrolled:', () => {
      ...
      describe('To loop point location:', () => {
        test('0', () => {
          scrollToLocation(engine, LOOP_POINTS_START[0])
        ...
        test('1', () => {
          scrollToLocation(engine, LOOP_POINTS_START[1])
        ...
        test('2', () => {
          scrollToLocation(engine, LOOP_POINTS_START[2])
        ...
        test('3', () => {
          scrollToLocation(engine, LOOP_POINTS_START[3])
        ...
        test('4', () => {
          scrollToLocation(engine, LOOP_POINTS_START[4])
        ...
        test('5', () => {
          scrollToLocation(engine, LOOP_POINTS_START[5])
        ...
        test('6', () => {
          scrollToLocation(engine, LOOP_POINTS_START[6])
      ...
      describe('Just before loop point location (0.01px):', () => {
        test('0', () => {
          scrollToLocation(engine, LOOP_POINTS_START[0])
          scrollToLocation(engine, LOOP_POINTS_START[0] + 0.01)
        ...
        test('1', () => {
          scrollToLocation(engine, LOOP_POINTS_START[1])
          scrollToLocation(engine, LOOP_POINTS_START[1] + 0.01)
        ...
        test('2', () => {
          scrollToLocation(engine, LOOP_POINTS_START[2])
          scrollToLocation(engine, LOOP_POINTS_START[2] + 0.01)
        ...
        test('3', () => {
          scrollToLocation(engine, LOOP_POINTS_START[3])
          scrollToLocation(engine, LOOP_POINTS_START[3] + 0.01)
        ...
        test('4', () => {
          scrollToLocation(engine, LOOP_POINTS_START[4])
          scrollToLocation(engine, LOOP_POINTS_START[4] + 0.01)
        ...
        test('5', () => {
          scrollToLocation(engine, LOOP_POINTS_START[5])
          scrollToLocation(engine, LOOP_POINTS_START[5] + 0.01)
        ...
        test('6', () => {
          scrollToLocation(engine, LOOP_POINTS_START[6])
          scrollToLocation(engine, LOOP_POINTS_START[6] + 0.01)
    ...
    describe('Slide positions when align is CENTER and the carousel is scrolled:', () => {
      ...
      describe('To loop point location:', () => {
        test('0', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[0])
        ...
        test('1', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[1])
        ...
        test('2', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[2])
        ...
        test('3', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[3])
        ...
        test('4', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[4])
        ...
        test('5', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[5])
        ...
        test('6', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[6])
      ...
      describe('Just before loop point location (0.01px):', () => {
        test('0', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[0])
          scrollToLocation(engine, LOOP_POINTS_CENTER[0] + 0.01)
        ...
        test('1', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[1])
          scrollToLocation(engine, LOOP_POINTS_CENTER[1] + 0.01)
        ...
        test('2', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[2])
          scrollToLocation(engine, LOOP_POINTS_CENTER[2] + 0.01)
        ...
        test('3', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[3])
          scrollToLocation(engine, LOOP_POINTS_CENTER[3] + 0.01)
        ...
        test('4', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[4])
          scrollToLocation(engine, LOOP_POINTS_CENTER[4] + 0.01)
        ...
        test('5', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[5])
          scrollToLocation(engine, LOOP_POINTS_CENTER[5] + 0.01)
        ...
        test('6', () => {
          scrollToLocation(engine, LOOP_POINTS_CENTER[6])
          scrollToLocation(engine, LOOP_POINTS_CENTER[6] + 0.01)
    ...
    describe('Slide positions when align is END and the carousel is scrolled:', () => {
      ...
      describe('To loop point location:', () => {
        test('0', () => {
          scrollToLocation(engine, LOOP_POINTS_END[0])
        ...
        test('1', () => {
          scrollToLocation(engine, LOOP_POINTS_END[1])
        ...
        test('2', () => {
          scrollToLocation(engine, LOOP_POINTS_END[2])
        ...
        test('3', () => {
          scrollToLocation(engine, LOOP_POINTS_END[3])
        ...
        test('4', () => {
          scrollToLocation(engine, LOOP_POINTS_END[4])
        ...
        test('5', () => {
          scrollToLocation(engine, LOOP_POINTS_END[5])
        ...
        test('6', () => {
          scrollToLocation(engine, LOOP_POINTS_END[6])
      ...
      describe('Just before loop point location (0.01px):', () => {
        test('0', () => {
          scrollToLocation(engine, LOOP_POINTS_END[0])
          scrollToLocation(engine, LOOP_POINTS_END[0] + 0.01)
        ...
        test('1', () => {
          scrollToLocation(engine, LOOP_POINTS_END[1])
          scrollToLocation(engine, LOOP_POINTS_END[1] + 0.01)
        ...
        test('2', () => {
          scrollToLocation(engine, LOOP_POINTS_END[2])
          scrollToLocation(engine, LOOP_POINTS_END[2] + 0.01)
        ...
        test('3', () => {
          scrollToLocation(engine, LOOP_POINTS_END[3])
          scrollToLocation(engine, LOOP_POINTS_END[3] + 0.01)
        ...
        test('4', () => {
          scrollToLocation(engine, LOOP_POINTS_END[4])
          scrollToLocation(engine, LOOP_POINTS_END[4] + 0.01)
        ...
        test('5', () => {
          scrollToLocation(engine, LOOP_POINTS_END[5])
          scrollToLocation(engine, LOOP_POINTS_END[5] + 0.01)
        ...
        test('6', () => {
          scrollToLocation(engine, LOOP_POINTS_END[6])
          scrollToLocation(engine, LOOP_POINTS_END[6] + 0.01)
...
describe('➡️  Loop - Horizontal RTL', () => {
  ...
  describe('Carousel with slides WITHOUT MARGINS has correct:', () => {
    ...
    describe('Position when align is START and the carousel is scrolled:', () => {
      const emblaApi = EmblaCarousel(mockTestElements(FIXTURE_LOOP_RTL_1), {
        loop: true,
        align: 'start',
        direction: 'rtl'
      })
  ...
  describe('Carousel with slides WITH MARGINS has correct:', () => {
    ...
    describe('Position when align is START and the carousel is scrolled:', () => {
      const emblaApi = EmblaCarousel(mockTestElements(FIXTURE_LOOP_RTL_2), {
        loop: true,
        align: 'start',
        direction: 'rtl'
      })
