...
`;var _=e.i(431480),g=e.i(907827),h=e.i(671249),$=e.i(893060),C=e.i(668347),O=e.i(654938);let N=t.css`
  .${$.CODE_HIGHLIGHT_CLASS_NAME} {
    background-color: ${i.COLORS.BACKGROUND_CODE};
    border-radius: ${C.PRISM_FRAME_RADIUS};
    border: ${h.BORDER_SIZES.DETAIL} solid ${i.COLORS.DETAIL_LOW_CONTRAST};
  ...
  .${n.PRISM_HIGHLIGHT_LINE_CLASS_NAME} {
    ...
    &:after {
      left: 0;
      width: ${h.BORDER_SIZES.ACCENT_VERTICAL};
      z-index: ${g.LAYERS.STEP};
    }
    &:before {
      right: 0;
...
`;let m=t.default.div.withConfig({displayName:"Styles__MdxStyles",componentId:"sc-41f18efa-0"})`
  ${N};
...
`,g=i.default.ol.withConfig({displayName:"TableOfContentsMenu__TableOfContentsMenuItemsWrapper",componentId:"sc-eca85ec3-2"})`
  list-style: none;
`,h=(0,i.default)(S.LinkNavigation).withConfig({displayName:"TableOfContentsMenu__Link",componentId:"sc-eca85ec3-3"})`
  padding-top: ${l.SPACINGS.ONE};
  padding-bottom: ${l.SPACINGS.ONE};
  ...
  ${({$level:e})=>e>0&&i.css`
    ...
    `};
`;function $(){let[e,i]=(0,a.useState)(""),o=(0,I.useTableOfContentsContext)(),n=(0,a.useMemo)(()=>o.map(e=>e.id||"").filter(Boolean),[o]);return((0,a.useEffect)(()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&i(e.target.id)})},{rootMargin:"0% 0% -80% 0%"});return n.forEach(t=>{let i=document.getElementById(t);i&&e.observe(i)}),()=>{n.forEach(t=>{let i=document.getElementById(t);i&&e.unobserve(i)})}},[n]),(0,A.arrayHasItems)(o))?(0,t.jsxs)(E,{children:[(0,t.jsx)(_,{children:"On this page"}),(0,t.jsx)(g,{children:o.map(i=>(0,t.jsx)("li",{children:(0,t.jsx)(h,{slug:`#${i.id||""}`,isActive:e===i.id,$level:i.level,children:i.text})},i.id))})]}):null}var C=e.i(907827),O=e.i(784613);let N=i.default.nav.withConfig({displayName:"TableOfContents__TableOfContentsWrapper",componentId:"sc-9a3f5612-0"})`
  ${s.MEDIA.DESKTOP} {
    position: fixed;
...
`;function u(){let e=(0,o.useAppSelector)(n.selectKeyNavigating);return(0,t.jsx)(N,{"aria-label":"table of contents",children:(0,t.jsx)(T,{$isKeyNavigating:e,children:(0,t.jsx)($,{})})})}e.s(["TableOfContents",()=>u],145360)},707095,e=>{"use strict";var t=e.i(843476),i=e.i(997053),o=e.i(109950),n=e.i(646107),a=e.i(515681),r=e.i(506390),l=e.i(801770),s=e.i(907827),d=e.i(728191),c=e.i(475086),S=e.i(112426),p=e.i(202623),f=e.i(145360);let I="28rem",A="21rem",E=l.SPACINGS.SEVEN,_=i.css`
  min-width: 0;
  flex: 0 0 auto;
...
`,h=i.default.main.withConfig({displayName:"PageGrid__Main",componentId:"sc-4288d600-1"})`
  flex: 1;
  min-width: 0;
  max-width: 100%;
  position: relative;
...
`,C=i.default.div.withConfig({displayName:"PageGrid__TableOfContentsWrapper",componentId:"sc-4288d600-3"})`
  ...
  ${({$isStartPage:e})=>e&&i.css`
      display: none;
    `};
`;function O(e){let{children:i,layout:a}=e,r=(0,o.useAppSelector)(n.selectRoutesLoading),l=a===d.PAGE_LAYOUTS.HOME,s=l?"MD":void 0,I=(0,c.useSidebarNavigationContext)(),A=(0,p.arrayHasItems)(I.flatRoutes);return(0,t.jsxs)(g,{size:s,children:[A&&(0,t.jsx)($,{$isStartPage:l,children:(0,t.jsx)(S.SidebarNavigation,{})}),(0,t.jsx)(h,{role:"main","aria-live":"polite",$isStartPage:l,"aria-busy":r,children:i}),(0,t.jsx)(C,{$isStartPage:l,children:(0,t.jsx)(f.TableOfContents,{})})]})}e.s(["MAIN_CONTENT_SPACING",0,E,"PageGrid",()=>O,"SIDEBAR_LG_DOWN_WIDTH",0,A,"SIDEBAR_LG_UP_WIDTH",0,I,"sidebarStyles",0,_])},959941,e=>{"use strict";var t=e.i(843476),i=e.i(997053),o=e.i(506390),n=e.i(350437),a=e.i(801770),r=e.i(925866),l=e.i(857355),s=e.i(380999),d=e.i(266349),c=e.i(174776),S=e.i(728191),p=e.i(784613);let f=i.default.div.attrs({id:S.MAIN_CONTENT_ID}).withConfig({displayName:"PageMainContent",componentId:"sc-ddfdd52f-0"})`
...
`,_=(0,i.default)(l.SiteLogo).withConfig({displayName:"HeroBrand__HeroLogo",componentId:"sc-130d8deb-1"})`
  flex: 0 0 auto;
...
`,h=i.default.h1.withConfig({displayName:"HeroBrand__H1",componentId:"sc-130d8deb-3"})`
