...
`;var _=e.i(431480),I=e.i(907827),$=e.i(671249),h=e.i(893060),O=e.i(668347),C=e.i(654938);let N=t.css`
...
`;e.i(843476);var m=e.i(890118);let u=t.default.div.withConfig({displayName:"ApiMetaData__ApiMetaDataWrapper",componentId:"sc-7fc4547e-0"})``;t.default.div.withConfig({displayName:"ApiMetaData__Row",componentId:"sc-7fc4547e-1"})`
...
`;let T=t.default.div.withConfig({displayName:"Styles__MdxStyles",componentId:"sc-41f18efa-0"})`
  ${N};
...
`;e.s(["MdxStyles",0,T],192770)},145360,e=>{"use strict";var t=e.i(843476),o=e.i(997053),i=e.i(109950),a=e.i(850056),n=e.i(271645),r=e.i(350437),l=e.i(801770),s=e.i(506390),d=e.i(671249),c=e.i(925866),S=e.i(764268),p=e.i(654938),A=e.i(728191),E=e.i(617199),g=e.i(202623);let f=o.default.div.withConfig({displayName:"TableOfContentsMenu__TableOfContentsMenuWrapper",componentId:"sc-eca85ec3-0"})`
...
`,_=o.default.div.withConfig({displayName:"TableOfContentsMenu__Heading",componentId:"sc-eca85ec3-1"})`
...
`,I=o.default.ol.withConfig({displayName:"TableOfContentsMenu__TableOfContentsMenuItemsWrapper",componentId:"sc-eca85ec3-2"})`
  list-style: none;
`,$=(0,o.default)(S.LinkNavigation).withConfig({displayName:"TableOfContentsMenu__Link",componentId:"sc-eca85ec3-3"})`
  padding-top: ${l.SPACINGS.ONE};
  padding-bottom: ${l.SPACINGS.ONE};
...
`,m=o.default.div.withConfig({displayName:"TableOfContents__MenuWrapper",componentId:"sc-9a3f5612-1"})`
  height: 100%;
...
`,N=(0,i.default)(r.Icon).withConfig({displayName:"PageBreadcrumbs__Separator",componentId:"sc-6318225-4"})`
  flex: 0 0 auto;
  color: ${l.COLORS.TEXT_LOW_CONTRAST};
  margin: 0 ${d.SPACINGS.ONE};
`;function m(){let e=(0,n.useRouteBreadcrumbs)(),i=(0,A.useAppSelector)(p.selectKeyNavigating);return(0,c.arrayHasItems)(e)?(0,t.jsx)(I,{"aria-label":"Breadcrumb Navigation",$isKeyNavigating:i,children:(0,t.jsx)($,{children:e.map(({slug:i,title:a},n)=>n!==e.length-1?(0,t.jsxs)(o.Fragment,{children:[(0,t.jsx)(O,{href:i,children:a}),(0,t.jsx)(N,{size:"0.8rem",svg:"chevronRight",role:"presentation","aria-hidden":"false"})]},i):(0,t.jsx)(C,{children:a},i))})}):null}e.s(["PageBreadcrumbs",()=>m])}]);