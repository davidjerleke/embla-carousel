...
`,K=(0,s.default)(m.Icon).withConfig({displayName:"SandboxSelectionInput__RadioLabelSvg",componentId:"sc-18c6d0d9-1"})`
  ${(0,_.createSquareSizeStyles)("3rem")};
  margin-bottom: ${u.SPACINGS.TWO};
`;function W(e){let{children:a,framework:t,...i}=e;return(0,l.jsx)(F,{...i,children:(0,l.jsxs)(M,{children:[(0,l.jsx)(K,{svg:Y[t]}),a]})})}var X=e.i(343869);let z="choose-sandbox",V=s.default.form.withConfig({displayName:"SandboxSelectionForm__SandboxSelectionFormWrapper",componentId:"sc-5d344c3-0"})`
  display: flex;
  flex-direction: column;
