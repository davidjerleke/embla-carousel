...
`;o.i(843476);var R=o.i(890118);let u=t.default.div.withConfig({displayName:"ApiMetaData__ApiMetaDataWrapper",componentId:"sc-7fc4547e-0"})``;t.default.div.withConfig({displayName:"ApiMetaData__Row",componentId:"sc-7fc4547e-1"})`
...
`;var N=o.i(923035);let b=t.default.div.withConfig({displayName:"Styles__MdxStyles",componentId:"sc-41f18efa-0"})`
  ${T};
  ...
  ${r.AdmonitionContent} ${N.IconWithTextText} > * {
    margin-bottom: ${n.SPACINGS.THREE};
  }

  ${l.TabsPanelWrapper} > *:first-child,
  ${r.AdmonitionContent}  ${N.IconWithTextText} > *:first-child,
  > *:first-child {
    margin-top: 0;
  }

  ${l.TabsPanelWrapper} > *:last-child, 
  ${r.AdmonitionContent} ${N.IconWithTextText} > *:last-child, 
  > *:last-child {
    margin-bottom: 0;
  }
`;o.s(["MdxStyles",0,b],192770)}]);