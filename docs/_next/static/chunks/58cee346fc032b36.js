...
`;function d(e){let{tab:o,activeTab:a,groupId:l,setActiveTab:s}=e,c=(0,n.useAppSelector)(i.selectKeyNavigating),d=o.value!==a.value,f=(0,r.useCallback)(()=>{s(o)},[s,o]);return(0,t.jsx)(u,{role:"tabpanel",id:`panel-id-${o.value}-${l}`,tabIndex:0,"aria-labelledby":`tab-id-${o.value}-${l}`,hidden:d,$isKeyNavigating:c,onClick:f,children:o.children})}e.s(["TabsPanel",()=>d,"TabsPanelWrapper",0,u],734568);var f=e.i(266349),p=e.i(801770),S=e.i(224583),h=e.i(350437),m=e.i(671249),A=e.i(907827),b=e.i(925866),g=e.i(764268);let _=(0,s.default)(S.ButtonBare).withConfig({displayName:"TabsButton__TabsButtonWrapper",componentId:"sc-994f2e2-0"})`
  ...
  ${({$selected:e})=>e&&s.css`
    ...
    `};
`,T=r.default.forwardRef(function(e,n){let{tab:i,activeTab:o,groupId:a,setActiveTab:l,...s}=e,c=i.value===o.value,u=(0,r.useCallback)(e=>{l(i,e.currentTarget)},[l]);return(0,t.jsxs)(_,{role:"tab",id:`tab-id-${i.value}-${a}`,tabIndex:c?0:-1,"aria-controls":`panel-id-${i.value}-${a}`,"aria-selected":c,$selected:c,disabled:i.disabled,onClick:u,ref:n,...s,children:[(0,t.jsx)(g.InactiveText,{$isActive:c,children:i.label}),(0,t.jsx)(g.ActiveText,{$isActive:c,"aria-hidden":"true",children:i.label})]})});e.s(["TabsButton",0,T,"TabsButtonWrapper",0,_],852079);var E=e.i(728191),v=e.i(654938);let I=s.default.div.withConfig({displayName:"TabsList__TabsListWrapper",componentId:"sc-35f9540d-0"})`
  display: flex;
  position: relative;
  margin-bottom: calc(${p.SPACINGS.FOUR} - ${v.SCROLLBAR_SIZE});
  overflow: hidden;
  ...
  &:after {
    ...
    width: 100%;
    display: block;
    bottom: calc(${v.SCROLLBAR_SIZE} - ${m.BORDER_SIZES.DETAIL});
    z-index: ${A.LAYERS.STEP};

    @media (hover: none), (hover: on-demand) {
      bottom: ${v.SCROLLBAR_SIZE};
    }
  }
`,y=s.default.div.withConfig({displayName:"TabsList__TabsListScrollArea",componentId:"sc-35f9540d-1"})`
  ${(0,v.createScrollBarStyles)("x")};
  ...
  @media (hover: none), (hover: on-demand) {
    overflow-x: auto;
    padding-bottom: ${v.SCROLLBAR_SIZE};
  }
  ...
  &:before {
    ${(0,v.createScrollBarShadowStyles)("left")};
    left: -4rem;
  }
  &:after {
    ${(0,v.createScrollBarShadowStyles)("right")};
    right: -4rem;
  }
`;function R(e){let{children:r,...o}=e,a=(0,n.useAppSelector)(i.selectKeyNavigating);return(0,t.jsx)(I,{...o,children:(0,t.jsx)(y,{$isKeyNavigating:a,children:r})})}e.s(["TabsList",()=>R,"TabsListScrollArea",0,y,"TabsListWrapper",0,I],354873);var O=e.i(172539);function L(e){return e?{offsetTop:e.offsetTop,rectTop:e.getBoundingClientRect().top}:{offsetTop:0,rectTop:0}}let C=s.default.div.withConfig({displayName:"Tabs__TabsWrapper",componentId:"sc-80591a53-0"})``;function N(e){let{groupId:s="",children:c,...u}=e,f=(0,n.useAppDispatch)(),p=(0,n.useAppSelector)(a.selectTabSelections)[s],S=(0,r.useMemo)(()=>(0,O.mapChildrenToTabs)(c),[c]),h=(0,r.useMemo)(()=>S.filter(e=>!e.disabled),[S]),[m,A]=(0,r.useState)((0,O.getDefaultTab)(h,p)),b=(0,r.useRef)(null),g=(0,r.useRef)(h.map(()=>r.default.createRef())),_=(0,r.useRef)((0,l.default)()),E=(0,r.useRef)(null),v=(0,r.useRef)(m.index),I=(0,r.useRef)(L(E.current)),y=(0,r.useCallback)(e=>{let t=h[e],r=g.current[e].current;t&&r&&(b.current=r,A(t),f((0,i.setIsKeyNavigating)(!0)),r.focus())},[h,f]),N=(0,r.useCallback)(e=>{let t=h.length,r=v.current,n={ArrowRight:()=>{y((r+1)%t)},ArrowLeft:()=>{y((r-1+t)%t)},Home:()=>{y(0)},End:()=>{y(t-1)}}[e.key];n&&(e.preventDefault(),n())},[h,y]),x=(0,r.useCallback)((e,t)=>{b.current=t,A(e)},[]);return o(()=>{v.current=m.index,s&&(I.current=L(E.current),f((0,a.setTabSelection)({key:s,value:m.value})),queueMicrotask(()=>{var e,t;let r,n;if(!b.current)return;b.current=null;let i=(e=L(E.current),t=I.current,r=e.offsetTop-t.offsetTop,Math.abs(r-(n=e.rectTop-t.rectTop))>1?n:r);i&&window.scrollBy({top:i}),I.current=L(E.current)}))},[h,m]),o(()=>{if(!s)return;let e=h.find(e=>e.value===p);e&&e.value!==h[v.current].value&&A(e)},[h,p]),(0,t.jsxs)(C,{ref:E,...u,children:[(0,t.jsx)(R,{role:"tablist","aria-orientation":"horizontal",children:S.map(e=>(0,t.jsx)(T,{groupId:_.current,tab:e,ref:g.current[e.index],activeTab:m,setActiveTab:x,onKeyDown:N},`${e.value}-${_.current}`))}),h.map(e=>(0,t.jsx)(d,{groupId:_.current,tab:e,activeTab:m,setActiveTab:A},`${e.value}-${_.current}`))]})}e.s(["Tabs",()=>N,"TabsWrapper",0,C],233127)},897364,172539,e=>{"use strict";var t=e.i(164645),r=e.i(271645);let n={GROUP_ID:"package-manager",TABS:{CDN:{LABEL:"CDN",VALUE:"cdn"},NPM:{LABEL:"npm",VALUE:"npm"},PNPM:{LABEL:"pnpm",VALUE:"pnpm"},YARN:{LABEL:"yarn",VALUE:"yarn"}}},i={GROUP_ID:"library",TABS:{VANILLA:{LABEL:"Vanilla",VALUE:"vanilla"},REACT:{LABEL:"React",VALUE:"react"},VUE:{LABEL:"Vue",VALUE:"vue"},SVELTE:{LABEL:"Svelte",VALUE:"svelte"},SOLID:{LABEL:"Solid",VALUE:"solid"}}};function o(e){let t=0;return r.default.Children.toArray(e).reduce((e,n)=>{if(!r.default.isValidElement(n)||!("tab"in n.props))return e;let{props:i}=n,o=r.default.cloneElement(n,{index:i.disabled?-1:t,label:i.tab.LABEL,value:i.tab.VALUE,...i});return i.disabled||(t+=1),[...e,o.props]},[])}function a(e,t){return e.find(e=>e.value===t)||e.find(e=>e.default)||e[0]}e.s(["TABS_LIBRARY",0,i,"TABS_PACKAGE_MANAGER",0,n,"TABS_SIDEBAR_NAVIGATION",0,{GROUP_ID:"",TABS:{MAIN_MENU:{LABEL:"Docs menu",VALUE:"docs-menu"},ON_THIS_PAGE:{LABEL:"On this page",VALUE:"table-of-contents"}}},"getDefaultTab",()=>a,"mapChildrenToTabs",()=>o],172539);let l={tabSelections:{[n.GROUP_ID]:n.TABS.NPM.VALUE,[i.GROUP_ID]:i.TABS.VANILLA.VALUE}},s=(0,t.createSlice)({name:"tabs",initialState:l,reducers:{setTabSelection:(e,t)=>{let{key:r,value:n}=t.payload;e.tabSelections[r]=n}}}),{name:c,reducer:u}=s,{setTabSelection:d}=s.actions;function f(e){return e.tabs.tabSelections}e.s(["selectTabSelections",()=>f,"setTabSelection",0,d,"tabsName",()=>c,"tabsReducer",()=>u],897364)},169075,e=>{"use strict";let t=e.i(801770).SPACINGS.CUSTOM(({ONE:e})=>e/2);function r(e,t){return t===e}function n(e,t){return t.substring(0,e.length)===e}function i(e,t){return e.order-t.order}e.s(["ROUTES_LOADING_BAR_HEIGHT",0,t,"addRouteChildren",()=>function e(t,r){if(!t)return t;let o={...t};return o.children=r.filter(({slug:e})=>n(o.slug,e)).filter(({level:e})=>e-1===o.level).sort(i),o.children.forEach(t=>e(t,r)),o},"isRouteActive",()=>r,"isRoutePartiallyActive",()=>n])},255130,e=>{"use strict";var t=e.i(843476),r=e.i(271645);let n=(0,r.createContext)({flatRoutes:[],homeRoute:{title:"",description:"",level:0,order:0,children:[],slug:"/"}});function i(e){let{routes:r,children:i}=e;return(0,t.jsx)(n.Provider,{value:r,children:i})}function o(){return(0,r.useContext)(n)}e.s(["HeaderNavigationProvider",()=>i,"useHeaderNavigationContext",()=>o])},955596,e=>{"use strict";var t=e.i(271645),r=e.i(618566),n=e.i(169075),i=e.i(475086),o=e.i(255130);function a(e){let i=(0,r.usePathname)();return(0,t.useMemo)(()=>({isActive:(0,n.isRouteActive)(e,i),isPartiallyActive:(0,n.isRoutePartiallyActive)(e,i)}),[e,i])}function l(){let e=(0,r.usePathname)(),t=(0,o.useHeaderNavigationContext)(),a=(0,i.useSidebarNavigationContext)(),l=[t.homeRoute,...a.flatRoutes],s=l.find(t=>t.slug===e);return l.filter(e=>(0,n.isRoutePartiallyActive)(e.slug,s?.slug||"")).sort((e,t)=>e.level-t.level)}function s(e){let t=(0,r.usePathname)();return e.filter(e=>(0,n.isRouteActive)(e.slug,t))[0]}function c(e,t){let r=(0,n.addRouteChildren)(t,e);return r?.children||[]}e.s(["useRouteActive",()=>a,"useRouteBreadcrumbs",()=>l,"useRouteChildren",()=>c,"useRouteCurrent",()=>s])},764268,e=>{"use strict";var t=e.i(843476),r=e.i(997053),n=e.i(955596),i=e.i(615632),o=e.i(266349),a=e.i(925866),l=e.i(350437),s=e.i(989023),c=e.i(331588);let u=(0,r.default)(i.LinkBare).withConfig({displayName:"LinkNavigation__LinkNavigationWrapper",componentId:"sc-8d505702-0"})`
  position: relative;
  display: inline-flex;
  align-items: center;
...
`,b=o.default.a.withConfig({displayName:"LinkBare__ExternalLink",componentId:"sc-9847dffd-1"})`
  ${m};
`;function g(e){let{href:o,id:l,tabIndex:s,children:c,onClick:f,...S}=e,m="string"==typeof o?o:o?.pathname||"",g=(0,r.useRef)(null),_=(0,n.useAppSelector)(i.selectKeyNavigating),T=(0,a.usePathname)(),E=(0,n.useAppDispatch)(),v=(0,r.useCallback)(()=>{E((0,u.setModalClosed)())},[E]),I=(0,r.useCallback)(e=>{f&&f(e),g.current||(g.current=document.createElement("a")),g.current.href=m;let t=T===g.current.pathname,r=e.metaKey||e.ctrlKey;t||r?g.current.hash?(setTimeout(()=>v(),0),(0,h.scrollToHash)(g.current.hash)):v():E((0,d.setRoutesLoading)(!0))},[T,m,v,E,f]);return p(m)?(0,t.jsx)(A,{href:m,id:l,tabIndex:s,onClick:I,$isKeyNavigating:_,...S,children:c}):(0,t.jsx)(b,{href:m,id:l,tabIndex:s,$isKeyNavigating:_,target:"_blank",rel:"noreferrer",...S,children:c})}e.s(["LinkBare",()=>g,"linkBareStyles",0,m],615632)},728191,e=>{"use strict";let t=e.i(801770).SPACINGS.FOUR;e.s(["MAIN_CONTENT_ID",0,"main-content","PAGE_FRAME_SIZES",0,{DEFAULT:"144rem",MD:"110rem",SM:"68rem"},"PAGE_FRAME_SPACING",0,t,"PAGE_LAYOUTS",0,{HOME:"Home",NOT_FOUND:"404",GENERATOR:"Generator",DOCS:"Docs"}])},475086,e=>{"use strict";var t=e.i(843476),r=e.i(271645);let n=(0,r.createContext)({hierarchicalRoutes:[],flatRoutes:[]});function i(e){let{routes:r,children:i}=e;return(0,t.jsx)(n.Provider,{value:r,children:i})}function o(){return(0,r.useContext)(n)}e.s(["SidebarNavigationProvider",()=>i,"useSidebarNavigationContext",()=>o])},923035,e=>{"use strict";var t=e.i(843476),r=e.i(997053),n=e.i(989023),i=e.i(801770);let o=r.default.span.withConfig({displayName:"IconWithText__IconWithTextWrapper",componentId:"sc-14b7e1d1-0"})`
  display: flex;
